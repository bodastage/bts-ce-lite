...
INNER JOIN zte_cm."RncFunction" t2 on  t2.data->>'SubNetwork_2_id' = t1.data->>'SubNetwork_2_id' 
    AND t2.data->>'meContext_id' = t1.data->>'meContext_id'
    AND t2.data->>'RncFunction_id' = t1.data->>'RncFunction_id'
