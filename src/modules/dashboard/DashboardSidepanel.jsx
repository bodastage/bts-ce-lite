    ...
    render() {
        return (
            <div>
                ...
                <a title="Process CM dumps" className="dropdown-item sidebar-item" href="/#" onClick={this.addTab({
                    component: 'ParseAndImport',
                    title: 'Parse and Import'
                })}> <FontAwesomeIcon icon="asterisk" /> Parse and Import</a>

                <a title="Reports" className="dropdown-item sidebar-item" href="/#" onClick={this.setSidePanel('ReportsTree')}> <FontAwesomeIcon icon="table" /> Reports</a>

                <a title="GIS" className="dropdown-item sidebar-item" href="/#" onClick={this.addTab({
                    component: 'GISMap',
                    title: 'GIS'
                })}> <FontAwesomeIcon icon="globe-africa" /> GIS</a>


                <a title="Baseline" className="dropdown-item sidebar-item" href="/#" onClick={this.addTab({
                    component: 'Baseline',
                    title: 'Baseline Audit'
                })}> <FontAwesomeIcon icon="pencil-ruler" /> Baseline</a>


                <a title="Parameter Reference" className="dropdown-item sidebar-item" href="/#" onClick={this.addTab({
                ...
                <a title="CSV to Excel" className="dropdown-item sidebar-item" href="/#" onClick={this.addTab({
                    component: 'CSVToExcelCombiner',
                    title: 'CSV to Excel'
                })}> <FontAwesomeIcon icon="file-excel" /> CSV to Excel</a>

                <a title="KML Generator" className="dropdown-item sidebar-item" href="/#" onClick={this.addTab({
                ...
                <a className="dropdown-item sidebar-item" title="Profile" href="/#"
                    onClick={this.addTab({
                ...
                <a className="dropdown-item sidebar-item" href="/#" title="Help" onClick={this.addTab({
                    component: 'Help', title: 'Help'
                })}><FontAwesomeIcon icon="question-circle" />  Help</a>

                <a className="dropdown-item sidebar-item" title="Log file" href="/#" onClick={this.showLogFile.bind(this)}><FontAwesomeIcon icon="file-alt" /> Log file</a>

                <a className="dropdown-item sidebar-item" href="/#" title="Settings" onClick={this.addTab({
                    component: 'Settings', title: 'Settings'
                })} ><FontAwesomeIcon icon="cog" />  Settings</a>
            </div>
        );
