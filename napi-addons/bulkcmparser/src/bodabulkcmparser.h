#ifndef __BODA_BULKCMPARSER_H
#define __BODA_BULKCMPARSER_H
...
namespace bodastage
{
    ...
    public:
         ...
         * @since 1.0.0
        */
        std::stack<string> xml_tag_stack;
        ...
        * @since 1.0.0
        */
        std::stack<string> vs_data_type_rl_stack;
         ...
         * @since 1.0.0
         */
        std::map<string, fstream> output_vs_data_type_pw_map;
         ...
         * @since 1.0.0
         */
        std::map<string, fstream> output_3gpp_mo_pw_map;
         ...
         * @since 1.0.0
         */
        std::map<string, std::stack<string>> mo_columns;
         ...
         * @since 1.0.0
         */
        std::map<string, std::stack<int>> mo_columns_parent_ids;
         ...
         * @since 1.0.0
         */
        std::map<string, std::stack<string>> mo_three_gpp_attr_map;
